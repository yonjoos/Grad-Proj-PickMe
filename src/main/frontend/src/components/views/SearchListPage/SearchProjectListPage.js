  ...
  const fetchSearchResultLists = async () => {
    try {
      ...
      const response = await request(
        "GET",
        `/getProjectSearchResult?${queryParams}`
      );
      ...
      <div style={{ textAlign: "left", margin: "0 0" }}>
        <Row>
          <Col span={18} style={{ textAlign: "left" }}>
            ...
            <Button
              type={
                location.pathname.includes("/search/portfoliocard")
                  ? "primary"
                  : "default"
              }
              onClick={handleSearchPortfolioCard}
            >
              Portfolios
            </Button>
            <Button
              type={
                location.pathname.includes("/search/project")
                  ? "primary"
                  : "default"
              }
            ...
            <Button
              type={
                location.pathname.includes("/search/study")
                  ? "primary"
                  : "default"
              }
