...
import { formatDatem, formatDateTime } from "../../../common/common";
        ...
        return (
            <div>
                <div style={{ marginTop: '10px' }}>
                    <Button style={{ width: '100%', height: '50px', backgroundColor: '#fffbcc' }} onClick={toggleContent}>
                    {isApplicantOpen ? (
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                    <div style={{ width: '100%', display: 'flex' }}>
                                        <Card title={<span style={{ fontSize: '15px' }}>지원자</span>}
                                            style={{ flex: 1 }}
                                            headStyle={{ paddingLeft: '15px', marginTop: '0px', backgroundColor: '#FFFDE5' }}
                                                ...
                                                <div key={index} style={{ marginTop: '15px' }}>
                                                    <Row>
                                                        ...
                                                        <Col span={8} style={{ display: 'flex', justifyContent: 'end' }}>
                                                            <Button
                                                                size="small"
                                                                style={{ backgroundColor: '#F2F9E8', boxShadow: '0px 3px 6px rgba(0, 0, 0, 0.1)' }}
                                                                onClick={() => {
                                                                setApplyUserNickname(applicant.nickName);
                                                                setApproveModalVisible(true);
                                                                if (data.counts === data.recruitmentCount) {
